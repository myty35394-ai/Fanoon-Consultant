...
export const metadata: Metadata = {
  title: "Civil Engineer Application | Fanoon Consultants",
  description: "Apply for the Civil Engineer position at Fanoon Consultants.",
};
...
const softwareList = [
  "AutoCAD", "Civil 3D", "Revit", "ETABS", 
  "STAAD.Pro", "SAP2000", "CSi Safe", "HEC-HMS", 
  "MS Project", "Primavera P6", "Tekla Structures", 
  "MS Excel", "LIRA SAPR", "Plaxis", "Other"
];

export default function CivilEngineerApplicationPage() {
  return (
    <>
          ...
          <div className="max-w-[560px] relative">
            <Breadcrumb
              items={[
                ...
                { label: "Civil Engineer Application" },
              ]}
              className="mb-10"
            />
            ...
            <h1 className="text-white font-bold leading-[1.1] mb-6" style={{ fontSize: "clamp(44px, 5vw, 64px)" }}>
              Building Better.<br />Engineering Tomorrow<span className="text-primary">.</span>
            </h1>

            <div className="w-10 h-[2px] bg-primary mb-6" />

            <p className="text-white/60 text-[15px] leading-[1.8] mb-12 max-w-[480px]">
              We are looking for dedicated civil engineers who can deliver practical, efficient and sustainable solutions that create lasting impact. Share your portfolio with us and help build a stronger tomorrow.
            </p>
      ...
      {/* â”€â”€ 2. MAIN CONTENT (Split Layout) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-10 items-start">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-32">
              <h2 className="text-charcoal font-bold text-[32px] leading-[1.2] mb-6">
                Strong Foundations.<br />Smarter Solutions.
              </h2>
              <div className="w-8 h-[2px] bg-primary mb-8" />
              <p className="text-dark-gray/80 text-[14px] leading-[1.8] mb-12">
                Our civil engineers work on infrastructure and development projects that improve communities and drive progress.
              </p>
              ...
              <div className="space-y-8 mb-12">
                <div className="flex gap-5">
                  ...
                  <div>
                    <h3 className="text-charcoal font-bold text-[14px] mb-1">Quality & Safety</h3>
                    <p className="text-dark-gray/70 text-[12.5px] leading-[1.6]">We ensure quality, compliance and safety at every stage.</p>
                  </div>
                </div>
                <div className="flex gap-5">
                  <Building2 className="w-7 h-7 text-primary flex-shrink-0" strokeWidth={1.5} />
                  <div>
                    <h3 className="text-charcoal font-bold text-[14px] mb-1">Infrastructure Impact</h3>
                    <p className="text-dark-gray/70 text-[12.5px] leading-[1.6]">Designing and managing projects that build strong communities.</p>
                  </div>
                </div>
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-dark-gray/70 text-[12.5px] leading-[1.6]">Work with multidisciplinary teams to deliver successful projects.</p>
                  </div>
                </div>
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-dark-gray/70 text-[12.5px] leading-[1.6]">Continuous learning with exposure to diverse, challenging projects.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-8">
              <JobApplicationForm
                role="Civil Engineer"
                formTitle="Civil Engineer Application Form"
                ...
                affiliationsPlaceholder="e.g. ASCE, ICE, PEC-affiliated bodies"
                specializationLabel="Civil Engineering Specialization"
                specializationOptions={[
                  { value: "construction", label: "Building & Construction Management" },
                  { value: "infrastructure", label: "Roads, Highways & Infrastructure" },
                  { value: "geotechnical", label: "Geotechnical & Foundation Engineering" },
                  { value: "water", label: "Water Supply & Sewerage Systems" },
                  { value: "supervision", label: "Site Supervision & Quality Control" },
                ]}
                qualificationOptions={[
                  { value: "bsc_civil", label: "B.Sc Civil Engineering" },
                  { value: "msc_civil", label: "M.Sc Civil Engineering" },
                  { value: "phd", label: "Ph.D in Civil Engineering" },
                  { value: "other", label: "Other" },
                ]}
                softwareList={["AutoCAD", "Civil 3D", "Primavera P6", "MS Project", "SAP2000", "ETABS", "Revit", "STAAD.Pro", "MATLAB", "GIS / ArcGIS", "Other"]}
                departmentOptions={[
                  { value: "construction", label: "Construction Management" },
                  { value: "engineering", label: "Civil & Structural Engineering" },
