...
export const metadata: Metadata = {
  title: "Privacy Policy | Fanoon Consultants",
  description:
    "At Fanoon Consultants, we value your trust and are committed to protecting your personal information. Read our complete privacy policy.",
  openGraph: {
    title: "Privacy Policy | Fanoon Consultants",
    description:
      "At Fanoon Consultants, we value your trust and are committed to protecting your personal information.",
  },
};
      ...
      <section className="relative w-full overflow-hidden bg-[#0a0f0c]">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-10">
          <div className="pt-32 pb-20 lg:pb-24" style={{ maxWidth: "620px" }}>
            ...
            >
              Your Privacy.<br />
              Our Responsibility<span className="text-primary">.</span>
            </h1>
            {/* Short green rule */}
            <div className="w-10 h-[3px] bg-primary rounded-sm mb-6" />
            <p className="text-white/80 text-[14.5px] leading-[1.8] max-w-lg">
              At {settings.companyName || "Fanoon Consultants"}, we value your trust and are committed to protecting your personal information.
            </p>
          </div>
        </div>
      </section>
